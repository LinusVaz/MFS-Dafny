// Dafny program grep.dfy compiled into C#
...
predicate matchAt(text: seq<char>, pattern: array<char>, i: int)
  ...
  reads pattern
  decreases {pattern}, text, pattern, i
{
  forall k: int {:trigger pattern[k]} :: 
    0 <= k < pattern.Length ==>
      text[i + k] == pattern[k]
}
...
method naiveSearch(text: seq<char>, pattern: array<char>) returns (pos: int)
  ...
  ensures pos == -1 ==> forall k: int {:trigger matchAt(text, pattern, k)} :: 0 <= k <= |text| - pattern.Length ==> !matchAt(text, pattern, k)
  decreases text, pattern
{
  pos := -1;
  if pattern.Length > |text| {
    return;
  }
  var i := 0;
  while i <= |text| - pattern.Length
    invariant 0 <= i
    invariant forall k: int {:trigger matchAt(text, pattern, k)} :: 0 <= k < i && k + pattern.Length <= |text| ==> !matchAt(text, pattern, k)
    decreases |text| - pattern.Length - i
  {
    var j := 0;
    var matched := true;
    while j < pattern.Length
      invariant 0 <= j <= pattern.Length
      invariant matched ==> forall k: int {:trigger pattern[k]} :: 0 <= k < j ==> text[i + k] == pattern[k]
...
method getLines(text: array<byte>) returns (lines: seq<seq<char>>)
  ensures forall i: int {:trigger lines[i]} :: 0 <= i < |lines| ==> noNewlines(lines[i])
  decreases text
{
  ...
  while i < text.Length
    ...
    invariant forall j: int {:trigger result[j]} :: 0 <= j < |result| ==> noNewlines(result[j])
  ...
  decreases env
{
  ...
  while i < |lines|
    ...
    decreases |lines| - i
  {
    var line_match := naiveSearch(lines[i], word);
    if line_match != -1 {
      found := true;
      print lines[i];
      print ""\n"";
...
class HostConstants {
  ...
  ghost function {:axiom} CommandLineArgs(): seq<seq<char>>
    reads this
    decreases {this}
...
class FileSystemState {
  ...
  ghost function {:axiom} state(): map<seq<char>, seq<byte>>
    reads this
    decreases {this}
}
...
class FileStream {
  ...
  ghost function {:axiom} Name(): seq<char>
    reads this
    decreases {this}

  ghost function {:axiom} IsOpen(): bool
    reads this
    decreases {this}
  ...
  static method {:axiom} {:extern} FileLength(name: array<char>, ghost env: HostEnvironment)
  ...
  static method {:axiom} {:extern} Open(name: array<char>, ghost env: HostEnvironment)
  ...
  method {:axiom} {:extern} Read(file_offset: nat32, buffer: array?<byte>, start: int32, num_bytes: int32)
      returns (ok: bool)
    requires env.Valid()
    requires env.ok.ok()
    requires IsOpen()
  ...
  method {:axiom} {:extern} Write(file_offset: nat32, buffer: array?<byte>, start: int32, num_bytes: int32)
      returns (ok: bool)
    requires env.Valid()
    requires env.ok.ok()
    requires IsOpen()
...
namespace _module {
  ...
  public partial class __default {
    public static bool noNewlines(Dafny.ISequence<Dafny.Rune> line) {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.Rune>, bool>>((_0_line) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_line).Count)), true, (((_forall_var_0) => {
        BigInteger _1_k = (BigInteger)_forall_var_0;
        return !(((_1_k).Sign != -1) && ((_1_k) < (new BigInteger((_0_line).Count)))) || (((_0_line).Select(_1_k)) != (new Dafny.Rune('\n')));
      }))))(line);
    }
    public static bool matchAt(Dafny.ISequence<Dafny.Rune> text, Dafny.Rune[] pattern, BigInteger i)
    {
      return Dafny.Helpers.Id<Func<Dafny.Rune[], Dafny.ISequence<Dafny.Rune>, BigInteger, bool>>((_0_pattern, _1_text, _2_i) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_pattern).Length)), true, (((_forall_var_0) => {
        BigInteger _3_k = (BigInteger)_forall_var_0;
        return !(((_3_k).Sign != -1) && ((_3_k) < (new BigInteger((_0_pattern).Length)))) || (((_1_text).Select((_2_i) + (_3_k))) == ((_0_pattern)[(int)(_3_k)]));
      }))))(pattern, text, i);
    }
    public static BigInteger naiveSearch(Dafny.ISequence<Dafny.Rune> text, Dafny.Rune[] pattern)
    {
      BigInteger pos = BigInteger.Zero;
      pos = new BigInteger(-1);
      if ((new BigInteger((pattern).Length)) > (new BigInteger((text).Count))) {
        return pos;
      }
      BigInteger _0_i;
      _0_i = BigInteger.Zero;
      while ((_0_i) <= ((new BigInteger((text).Count)) - (new BigInteger((pattern).Length)))) {
        BigInteger _1_j;
        _1_j = BigInteger.Zero;
        bool _2_matched;
        _2_matched = true;
        while ((_1_j) < (new BigInteger((pattern).Length))) {
          if (((text).Select((_0_i) + (_1_j))) != ((pattern)[(int)(_1_j)])) {
            _2_matched = false;
            goto after_1_0;
          }
    ...
    public static Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> getLines(byte[] text)
    {
      ...
      _0_result = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements();
      Dafny.ISequence<Dafny.Rune> _1_current;
      _1_current = Dafny.Sequence<Dafny.Rune>.FromElements();
      BigInteger _2_i;
      _2_i = BigInteger.Zero;
      while ((_2_i) < (new BigInteger((text).Length))) {
        if ((new Dafny.Rune((int)((text)[(int)(_2_i)]))) == (new Dafny.Rune('\n'))) {
          _0_result = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.Concat(_0_result, Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(_1_current));
          _1_current = Dafny.Sequence<Dafny.Rune>.FromElements();
        } else {
          _1_current = Dafny.Sequence<Dafny.Rune>.Concat(_1_current, Dafny.Sequence<Dafny.Rune>.FromElements(new Dafny.Rune((int)((text)[(int)(_2_i)]))));
        }
        _2_i = (_2_i) + (BigInteger.One);
      }
      if (!(_1_current).Equals(Dafny.Sequence<Dafny.Rune>.FromElements())) {
        _0_result = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.Concat(_0_result, Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(_1_current));
      }
      lines = _0_result;
      return lines;
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      _0_numArgs = _out0;
      if ((_0_numArgs) != (3U)) {
        Dafny.Helpers.Print((new BigInteger(_0_numArgs)));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Wrong usage\n")).ToVerbatimString(false));
        return ;
      }
      Dafny.Rune[] _1_word;
      Dafny.Rune[] _out1;
      ...
      _2_file = _out2;
      if ((new BigInteger((_1_word).Length)).Sign != 1) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Invalid Word\n")).ToVerbatimString(false));
        return ;
      }
      bool _3_exist;
      bool _out3;
      _out3 = FileStream.FileExists(_2_file);
      _3_exist = _out3;
      if (!(_3_exist)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("File does not exist\n")).ToVerbatimString(false));
        return ;
      }
      bool _4_success;
      int _5_len;
      bool _out4;
      int _out5;
      FileStream.FileLength(_2_file, out _out4, out _out5);
      _4_success = _out4;
      _5_len = _out5;
      if (!(_4_success)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Could not get file length\n")).ToVerbatimString(false));
        return ;
      }
      FileStream _6_fileStream = default(FileStream);
      bool _7_open = false;
      bool _out6;
      FileStream _out7;
      FileStream.Open(_2_file, out _out6, out _out7);
      _7_open = _out6;
      _6_fileStream = _out7;
      if (!(_7_open)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Could not open file\n")).ToVerbatimString(false));
        return ;
      }
      byte[] _8_buffer;
      byte[] _nw0 = new byte[Dafny.Helpers.ToIntChecked(_5_len, "array size exceeds memory limit")];
      _8_buffer = _nw0;
      bool _9_read;
      bool _out8;
      _out8 = (_6_fileStream).Read(0, _8_buffer, 0, _5_len);
      _9_read = _out8;
      if (!(_9_read)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Could not read file\n")).ToVerbatimString(false));
        return ;
      }
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _10_lines;
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _out9;
      _out9 = __default.getLines(_8_buffer);
      _10_lines = _out9;
      bool _11_found;
      _11_found = false;
      BigInteger _12_i;
      _12_i = BigInteger.Zero;
      while ((_12_i) < (new BigInteger((_10_lines).Count))) {
        BigInteger _13_line__match;
        BigInteger _out10;
        _out10 = __default.naiveSearch((_10_lines).Select(_12_i), _1_word);
        _13_line__match = _out10;
        if ((_13_line__match) != (new BigInteger(-1))) {
          _11_found = true;
          Dafny.Helpers.Print(((_10_lines).Select(_12_i)).ToVerbatimString(false));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
        }
        _12_i = (_12_i) + (BigInteger.One);
      }
      if (!(_11_found)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("No matching lines\n")).ToVerbatimString(false));
      }
    }
  }
  ...
  public partial class nat32 {
    ...
    public static bool _Is(int __source) {
      BigInteger _14_i = new BigInteger(__source);
      return ((_14_i).Sign != -1) && ((_14_i) < (new BigInteger(2147483648L)));
    }
  }
